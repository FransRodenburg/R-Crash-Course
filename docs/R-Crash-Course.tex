...
\label{tab:unnamed-chunk-19}Tidy data. Every row is a single flower. Every column is a single variable.
...
\label{tab:unnamed-chunk-20}Untidy data. A single row contains three different experimental observations.
