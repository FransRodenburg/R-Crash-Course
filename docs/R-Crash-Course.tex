...
\hypersetup{
  ...
  pdfauthor={Dr.~F.J. Rodenburg   © 2021--2024 Universiteit Leiden},
  hidelinks,
...
\addcontentsline{toc}{subsection}{R Crash Course (2024)}
...
\addcontentsline{toc}{subsection}{Basic Statistics (2023)}
...
\label{tab:unnamed-chunk-22}Tidy data. Every row is a single flower. Every column is a single variable.
...
\label{tab:unnamed-chunk-23}Untidy data. A single row contains three different experimental observations.
